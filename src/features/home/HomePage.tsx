  ...
  return (
    <>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 pt-6 pb-12 mx-auto w-1/2 ">
          <div className="flex flex-wrap -m-4 text-center ">
            <div className="card p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="item item--1 border-2 border-gray-200 px-4 py-6 rounded-lg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  ...
                  <g clip-path="url(#b)">
                    <path
                      fill="#F7BE8F"
                      d="M33 39c0 .6-.4 1-1 1s-1-.4-1-1h2z"
                    />
                  </g>
                  <g clip-path="url(#b)">
                    <path
            ...
            <div className="card p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="item item--2 border-2 border-gray-200 px-4 py-6 rounded-lg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  id="_1_-_10"
                  data-name="1 - 10"
                ...
                >
                  ...
                  <g id="Library">
                    ...
                    <path
                      className="cls-2"
                      d="M8,6H5A3,3,0,0,0,2,9V39a3,3,0,0,0,3,3H8Z"
                    />
                    <path
                      className="cls-3"
                      d="M11,14H5a1,1,0,0,1,0-2h6a1,1,0,0,1,0,2Z"
                    />
                    <path className="cls-4" d="M8,14V12H5a1,1,0,0,0,0,2Z" />
                    <path
                      className="cls-3"
                      d="M11,36H5a1,1,0,0,1,0-2h6a1,1,0,0,1,0,2Z"
                    />
                    <path className="cls-4" d="M8,36V34H5a1,1,0,0,0,0,2Z" />
                    <rect
                      className="cls-5"
                      x="15"
                      y="6"
                    ...
                    <path
                      className="cls-6"
                      d="M21,6H18a3,3,0,0,0-3,3V39a3,3,0,0,0,3,3h3Z"
                    />
                    <path
                      className="cls-3"
                      d="M24,14H18a1,1,0,0,1,0-2h6a1,1,0,0,1,0,2Z"
                    />
                    <path className="cls-4" d="M21,14V12H18a1,1,0,0,0,0,2Z" />
                    <path
                      className="cls-3"
                      d="M24,36H18a1,1,0,0,1,0-2h6a1,1,0,0,1,0,2Z"
                    />
                    <path className="cls-4" d="M21,36V34H18a1,1,0,0,0,0,2Z" />
                    <rect
                      className="cls-7"
                      x="31.219"
                      y="5.735"
                      ...
                      height="36"
                      rx="3"
                      transform="translate(-4.875 10.442) rotate(-15)"
                    />
                    <path
                      className="cls-8"
                      d="M32.56,6.348l-2.9.777A3,3,0,0,0,27.541,10.8l7.765,28.978A3,3,0,0,0,38.98,41.9l2.9-.777Z"
                    />
                    <path
                      className="cls-3"
                      d="M37.529,13.3l-5.8,1.553a1,1,0,0,1-.518-1.932l5.8-1.553a1,1,0,0,1,.518,1.932Z"
                    />
                    <path
                      className="cls-4"
                      d="M34.631,14.076l-.518-1.932-2.9.776a1,1,0,0,0,.518,1.932Z"
                    />
                    <path
                      className="cls-3"
                      d="M43.223,34.549l-5.8,1.553a1,1,0,1,1-.518-1.931l5.8-1.553a1,1,0,1,1,.518,1.931Z"
                    />
                    <path
                      className="cls-4"
                      d="M40.325,35.326l-.518-1.932-2.9.777a1,1,0,1,0,.518,1.931Z"
                    />
                  </g>
                </svg>
                <span className="quantity"> 70+ </span>
                <span className="text text--2"> Books </span>
              </div>
            </div>
            <div className="card p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="item item--3 border-2 border-gray-200 px-4 py-6 rounded-lg">
                <svg
                  height="24"
                  width="24"
                  viewBox="0 0 24 24"
                ...
                <span className="text text--3"> Views </span>
              </div>
            </div>
            <div className="card p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="item item--4 border-2 border-gray-200 px-4 py-6 rounded-lg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                  xmlSpace="preserve"
